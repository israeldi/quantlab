...
\begin{titlepage}
\begin{center}
 {\huge\bfseries Quant\\Technical Interview Hints\\}
 % ----------------------------------------------------------------
 \vspace{1.5cm}
...
\end{problem}
Hint: what is the standard deviation of the number of heads?

\begin{problem}
%\cite{STRAWA}
%Starting at one vertex of a cube, and moving randomly from vertex to adjacent vertices, what is the expected number of moves until you reach the  vertex opposite from your starting point?
\end{problem}
Hint: How many states are there? Can you reduce it? How much can you reduce it?
...
\end{problem}
Hint: If you answered 0.75, consider your answer if you flipped just once, and got one head. Try Bayes' Theorem to get expected value by conditioning on the observed outcome.
...
\end{problem}
Hint: one solution is to use something akin to the Running Median problem, which uses a pair of max and min heaps.
...
\end{problem}
Hint: This is similar to the LeetCode Two Sum problem, so use a dictionary.
...
\end{problem}
Hint: Use a boolean array of length one million.
...
\end{problem}
Hint: it doesn't say the number of heads must remain at 10, so you can flip coins over.
...
\end{problem}
Hint: suppose there were only two pirates. 
...
\end{problem}
Hint: the slow people need to cross together.
...
\end{problem}
Hint: imagine the penny is impossibly dense, weighing so much that the canoe is on the verge of sinking.
...
\end{problem}
Hint: where is the treasure after an even number of moves?
...
\end{problem}
Hint: play a smaller version of the game to gain insight. Bigger hint: look up the game of Nim.
...
\end{problem}
Hint: Can you benefit from weighing only some of the coins?
...
\end{problem}
Hint: Once weighed, you know where there are coins that weigh the same. Can you swap those in to determine where the  odd coin is?
...
\end{problem}
Hint: what do you get if you combine the amount of wine in one glass with the amount of wine in the other glass?
...
\end{problem}
Hint: whether a coin gets flipped is related to the number of factors of the coin's number. What kind of numbers have an odd number of factors?
...
\end{problem}
Hint: If you raced winners against each other, what can you conclude about the horses that initially ran against the winners?
...
\end{problem}
Hint: Try with a smaller number of floors to gain insight.

\begin{problem}
%You have two strings, and a lighter. If you light a string at one end, it burns for one hour. You have no way of measuring or cutting the strings. How would you measure 45 minutes? 
\end{problem}
Hint: what happens if you light both ends of a string?
...
\end{problem}
Hint: You are at the center of a circle of radius 1 mile. Consider a single tangent to that circle. Your objective must include reaching that tangent, travel around and touch the tangent again. 
...
\end{problem}
Hint: we don't say that roads meet in a village. There could be a junction outside of the town where roads meet. 
...
\end{problem}
Hint: Does it matter whether Betty is a programmer or non-programmer?
...
\end{problem}
Hint: Change the problem abstraction, treating the first passenger's seat as the equivalent of drawing a particular marble (say black) out of a jar. Treat the last passenger's seat as a white marble. Everyone else's seat corresponds to a gray marble. Now treat this as a problem where we draw marbles from the jar. 
...
\end{problem}
Hint: The implication is that the first captain may not survive. What is the largest number of pirates where the captain will survive?
...
\end{problem}
Hint: We don't say the marbles will be distributed evenly between the jars. 
